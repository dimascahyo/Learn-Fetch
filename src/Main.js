            ...
            <HashRouter>
                <div>
                    ...
                    <ul className="header">
                        ...
                        <li><NavLink exact to="/turkey">Turkey</NavLink></li>
                        <li><NavLink exact to="/indonesia">Finland</NavLink></li>
                    ...
                    <div className="content">
                        ...
                        <Route exact path="/indonesia" component={Finland}/>
